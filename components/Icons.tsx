...
export const TwitterIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="currentColor" viewBox="0 0 24 24">
    <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616v.064c0 2.298 1.634 4.212 3.793 4.649-.65.177-1.354.23-2.09.088.608 1.883 2.373 3.256 4.464 3.294-1.711 1.341-3.883 2.14-6.236 2.14-.406 0-.806-.024-1.2-.074 2.221 1.428 4.862 2.26 7.734 2.26 9.284 0 14.377-7.697 14.377-14.377 0-.218-.005-.436-.014-.653.986-.713 1.84-1.608 2.518-2.618z" />
  </svg>
);
